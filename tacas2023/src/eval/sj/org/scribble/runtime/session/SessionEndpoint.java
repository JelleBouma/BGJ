...
import eval.sj.org.scribble.runtime.net.BinaryChannelEndpoint;
import eval.sj.org.scribble.runtime.net.BinaryChannelWrapper;
import eval.sj.org.scribble.runtime.net.ScribServerSocket;
...
public abstract class SessionEndpoint<S extends eval.sj.org.scribble.runtime.session.Session, R extends Role> implements AutoCloseable
{
	...
	private final eval.sj.org.scribble.runtime.session.ScribInputSelector sel;
	...
	public SessionEndpoint(S sess, R self, ScribMessageFormatter smf) throws IOException, ScribRuntimeException
	{
		...
		this.sel = new eval.sj.org.scribble.runtime.session.ScribInputSelector(this);
		this.sel.start();
	}
